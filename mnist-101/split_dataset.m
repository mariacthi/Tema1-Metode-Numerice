function [X_train, y_train, X_test, y_test] = split_dataset(X, y, percent)
  ...
  % generating a random permutation of the rows of the matrix
  perm = randperm(r);
  num = round(percent * r);

  % splitting the randomly generated permutations
  train_numbers = perm(1 : num);
  test_numbers = perm((num + 1)  : end);
